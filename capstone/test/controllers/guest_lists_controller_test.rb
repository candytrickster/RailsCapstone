...
class GuestListsControllerTest < ActionController::TestCase
  ...
  test "should create guest_list" do
    assert_difference('GuestList.count') do
      post :create, guest_list: { email: @guest_list.email, name: @guest_list.name, relationship: @guest_list.relationship, status: @guest_list.status, user_id: @guest_list.user_id }
    end
  ...
  test "should update guest_list" do
    patch :update, id: @guest_list, guest_list: { email: @guest_list.email, name: @guest_list.name, relationship: @guest_list.relationship, status: @guest_list.status, user_id: @guest_list.user_id }
    assert_redirected_to guest_list_path(assigns(:guest_list))
  end
