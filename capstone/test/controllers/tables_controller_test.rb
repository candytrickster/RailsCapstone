...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { name: @table.name, num_of_seats: @table.num_of_seats, position: @table.position, size: @table.size, type: @table.type, user_id: @table.user_id }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { name: @table.name, num_of_seats: @table.num_of_seats, position: @table.position, size: @table.size, type: @table.type, user_id: @table.user_id }
    assert_redirected_to table_path(assigns(:table))
  end
